<?php
  ...
  function get_genetic_map_name($chrom, $map) {
    ...
    if ($map == 2) {
       ...
       if ($chrom == 1) return $prefix . "umc981";
       else if ($chrom == 2) return $prefix . "umc982";
       else if ($chrom == 3) return $prefix . "umc983";
       else if ($chrom == 4) return $prefix . "umc984";
       else if ($chrom == 5) return $prefix . "umc985";
       else if ($chrom == 6) return $prefix . "umc986";
       else if ($chrom == 7) return $prefix . "umc987";
       else if ($chrom == 8) return $prefix . "umc988";
       else if ($chrom == 9) return $prefix . "umc989";
       else if ($chrom == 10) return $prefix . "umc9810";
    ...
    if(($chrom == 1) && ($map == 1)) return "umc981";
    else if(($chrom == 2) && ($map == 1)) return "umc982";
    else if(($chrom == 3) && ($map == 1)) return "umc983";
    else if(($chrom == 4) && ($map == 1)) return "umc984";
    else if(($chrom == 5) && ($map == 1)) return "umc985";
    else if(($chrom == 6) && ($map == 1)) return "umc986";
    else if(($chrom == 7) && ($map == 1)) return "umc987";
    else if(($chrom == 8) && ($map == 1)) return "umc988";
    else if(($chrom == 9) && ($map == 1)) return "umc989";
    else if(($chrom == 10) && ($map == 1)) return "umc9810";
    else if(($chrom == 1) && ($map == 2)) return "gen1";
    else if(($chrom == 2) && ($map == 2)) return "gen2";
    else if(($chrom == 3) && ($map == 2)) return "gen3";
    else if(($chrom == 4) && ($map == 2)) return "gen4";
    else if(($chrom == 5) && ($map == 2)) return "gen5";
    else if(($chrom == 6) && ($map == 2)) return "gen6";
    else if(($chrom == 7) && ($map == 2)) return "gen7";
    else if(($chrom == 8) && ($map == 2)) return "gen8";
    else if(($chrom == 9) && ($map == 2)) return "gen9";
    else if(($chrom == 10) && ($map == 2)) return "gen10";
  }
